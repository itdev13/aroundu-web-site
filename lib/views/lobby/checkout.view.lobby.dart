...
//                             );
//                           } else {
//                             Get.off(() => HyperCheckOutPaymentView(
//                                   // amount: 100,
//                                   userId: profileController
//                                           .profileData.value?.userId ??
//                                       "",
...
//                               msg: "can't proceed with 0 amount");
//                         }
//                       },
//                       bgColor: (count > 0 &&
//                               ref
...
//                       spreadRadius: 2,
//                       color: Color(
//                           0x143E79A1), // #3E79A114: 0x14 is the alpha value
//                     ),
//                   ],
//                   color: Colors.white,
//                 ),
...
//                                   maxLines: 2,
//                                 ),
//                                 if (widget.lobby.filter.otherFilterInfo
//                                         .dateRange !=
//                                     null) ...[
//                                   Space.h(height: 8.h),
//                                   Row(
...
//                                   questions: widget.formModel!.questions
...
//       {required PricingResponse? pricingData, Offer? selectedOffer}) {
//     double total = pricingData?.total ?? 0.0;
//     if (selectedOffer != null) {
//       if (selectedOffer.discountType == 'PERCENTAGE') {
//         // double percentage = selectedOffer.discountValue;
//         double discount = double.parse(calculateDiscount(
//             pricingData: pricingData, selectedOffer: selectedOffer));
